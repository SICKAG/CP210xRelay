...
// project whose source files include this file see CP210xRUNTIMEDLL_API
...
CP210xRUNTIMEDLL_API CP210x_STATUS CP210xRT_ReadLatch(HANDLE cyHandle,
                                                      LPWORD lpLatch);

CP210xRUNTIMEDLL_API CP210x_STATUS WINAPI CP210xRT_WriteLatch(HANDLE cyHandle,
                                                              WORD mask,
                                                              WORD latch);
